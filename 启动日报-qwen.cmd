...
echo Generating daily digest with LAN Qwen 3.8-27B...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%PROJECT_ROOT%scripts\run_daily.ps1" %OPEN_SWITCH% %REQUIRE_SWITCH% -Config "%PROJECT_ROOT%config\settings.qwen.yaml" -ExperimentId "qwen3.8-27b" %EXTRA_SWITCHES%
if errorlevel 1 goto failed
